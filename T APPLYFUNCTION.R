...
#choose LungCapData.txt (i.e text document not Excel file)

# check the data
summary(LungCapData)
# read what func attach does and run
?attach 
attach(LungCapData)
...
# this gets the mean age of smokers and non-smokers in the LungCapDatadataset
#splits Age into two classifications (i.e factors) Smoke == yes and Smoke == no
#gets mean age of each of two columns
